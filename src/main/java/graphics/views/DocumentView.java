...
public class DocumentView extends JPanel {
    ...
    public DocumentView(DocumentModel model) {
        setBorder(BorderFactory.createTitledBorder("Документы"));
        ...
        titleLabel = new JLabel("ФИО:");
        titleLabel.setLabelFor(title);


        tasterLabel = new JLabel("О себе");
...
//        add(tasterPanel);
        ...
        JButton button = new JButton(new DisplayTextAction("Сгенерировать документ", () -> model.getDocument().toString()));
