...
import graphics.models.EntryModel;
...
public class EntryView extends JPanel {
    ...
    public EntryView(EntryModel model) {
        ...
        locationLabel = new JLabel("Место:");
        ...
        JButton generatedEntry = new JButton(new DisplayTextAction("Сгенерировать", () -> this.model.getEntry().toString()));
